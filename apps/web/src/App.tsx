...
import { ErrorBoundary, RouteErrorBoundary } from './core/errors';
...
function AppRoutes() {
  ...
  return (
    <Routes>
      <Route path="/landing" element={<LandingRoute />} errorElement={<RouteErrorBoundary />} />
      <Route path="/auth" element={<Navigate to="/auth/login" replace />} />
      <Route path="/auth/:mode" element={<AuthRoute />} errorElement={<RouteErrorBoundary />} />
...
function App() {
  return (
    <ErrorBoundary name="AppRoot" level="fatal">
      <AuthProvider>
        <BrowserRouter>
          <AppRoutes />
        </BrowserRouter>
